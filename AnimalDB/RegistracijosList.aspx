<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RegistracijosList.aspx.cs" Inherits="AnimalDB.RegistracijosList" %>
...
<body>
   ...
   <div align="center">
        ...
        <asp:Button ID="Klasės" runat="server" OnClick="Klasės_Click1" Text="Klasės" BackColor="#666666" BorderStyle="Solid" Height="40px" Width="100px" />
            ...
            <asp:Button ID="Button1" runat="server" BackColor="#666666" Height="40px" OnClick="Button1_Click1" Text="Ataskaitos" Width="100px" />
            ...
            <br />
            <br />
            Registracijų lentelė<br />
            <asp:Button ID="PridetiReg" runat="server" OnClick="Button1_Click" Text="Pridėti registraciją" EnableTheming="True" />
            <br />
