<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="VeisleList.aspx.cs" Inherits="AnimalDB.VeisleList" %>
...
<body>
   ...
   <div align="center">
        ...
        <asp:Button ID="Klasės" runat="server" OnClick="Klasės_Click1" Text="Klasės" BackColor="#666666" BorderStyle="Solid" Height="40px" Width="100px" />
            ...
            <br />
            Veislių lentelė<br />
            <asp:Button ID="PridetiVeisle" runat="server" OnClick="Button1_Click" Text="Pridėti Veislę" />
            <br />
