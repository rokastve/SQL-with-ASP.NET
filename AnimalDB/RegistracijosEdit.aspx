<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RegistracijosEdit.aspx.cs" Inherits="AnimalDB.RegistracijosEdit" %>
...
<body>
    ...
    <br />
    <asp:Label ID="Label5" runat="server" Text="Numeris"></asp:Label>
    <asp:TextBox ID="TextBox1" runat="server" ReadOnly="True"></asp:TextBox>
    <br />
    <asp:Label ID="Label6" runat="server" Text="Data"></asp:Label>
    <asp:TextBox ID="TextBox2" runat="server">yyyy-dd-mm</asp:TextBox>
    <br />
    <asp:Label ID="Label4" runat="server" Text="Vieta"></asp:Label>
    <asp:TextBox ID="TextBox3" runat="server"></asp:TextBox>
            <br />
            <asp:Label ID="Label10" runat="server" Text="Savininko Asmens Kodas"></asp:Label>
            <asp:DropDownList ID="DropDownList1" runat="server">
            </asp:DropDownList>
            <br />
            <asp:Label ID="Label11" runat="server" Text="Veterinaro Asmens Kodas"></asp:Label>
