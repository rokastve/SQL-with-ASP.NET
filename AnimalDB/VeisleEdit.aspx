<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="VeisleEdit.aspx.cs" Inherits="AnimalDB.VeisleEdit" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <p>
            ...
            <asp:Label ID="Label2" runat="server" Text="Veislės redagavimas"></asp:Label>
    ...
    <br />
    <asp:Label ID="Label5" runat="server" Text="Kilmės Šalis"></asp:Label>
    <asp:TextBox ID="TextBox1" runat="server"></asp:TextBox>
    <br />
    <asp:Label ID="Label6" runat="server" Text="Gyvenimo Trukmė"></asp:Label>
    <asp:TextBox ID="TextBox2" runat="server"></asp:TextBox>
    <br />
    <asp:Label ID="Label4" runat="server" Text="Pavadinimas"></asp:Label>
    <asp:TextBox ID="TextBox3" runat="server" ReadOnly="True"></asp:TextBox>
            <br />
            <asp:Label ID="Label7" runat="server" Text="Klasės Pavadinimas"></asp:Label>
