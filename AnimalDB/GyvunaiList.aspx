<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GyvunaiList.aspx.cs" Inherits="AnimalDB.GyvunaiList" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <asp:Button ID="Klasės" runat="server" OnClick="Klasės_Click1" Text="Klasės" BackColor="#666666" BorderStyle="Solid" Height="40px" Width="100px" />
            ...
            <br />
            <br />
            <asp:Label ID="NameTag" runat="server" Text="Gyvūnų lentelė"></asp:Label>
            <br />
            <asp:Button ID="PridetiGyvūną" runat="server" OnClick="Button1_Click" Text="Pridėti Gyvūną" />
            <br />
