<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="HomePage.aspx.cs" Inherits="AnimalDB.HomePage" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <asp:Panel ID="Panel2" runat="server" Height="286px" Font-Bold="True" Font-Size="Large" HorizontalAlign="Center" style="margin-top: 14px">
            Duomenų bazių L2 atsiskaitymas<br /> Kūrė: IFF-6/15gr. studentas Rokas Tverijonas</asp:Panel>
            </div>
    </form>
</body>
</html>
